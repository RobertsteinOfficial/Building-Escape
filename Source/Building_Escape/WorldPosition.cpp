...
void UWorldPosition::BeginPlay()
{
	...
	//UE_LOG(LogTemp, Warning, TEXT("%s"), **PtrLog);		//devo usare due asterischi perchè per le stringhe * è overloaded, 
	//														//quindi in realtà il primo è il pointer, il secondo è l'overloaded operator
